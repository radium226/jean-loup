...
class PydanticAnnotationForIPV4Address:
        ...
        return json_or_python_schema(
            ...
            python_schema=union_schema(
                [
                    ...
                    is_instance_schema(ipaddress.IPv4Address),
                    from_str_schema,
                ]
            ),
...
IPv4Address = Annotated[ipaddress.IPv4Address, PydanticAnnotationForIPV4Address]